...
<div class="wrap wb-admin">
      ...
      <table class="widefat options" style="width: 650px">
		...
		<td class="kma-admin-td"><label><input type="text" style="width:125px;" maxlength="55" value="<?php echo get_option('kma_width'); ?>" name="kma_width" id="kma_width" class="regular-text" />px</label>
