...
<div class="wrap wb-admin">
		...
		<td class="kma-admin-td"><input type="text" style="width:125px;" maxlength="255" name="kma_background_url" id="kma_background_url" class="regular-text" />
      ...
      <tr valign="top">
		...
		<td class="kma-admin-td"><input type="text" style="width:125px;" maxlength="255" name="kma_background_partner_url" id="kma_background_partner_url" class="regular-text" />
       ...
       <tr valign="top">
        ...
        <?php $categories = array(); $categories = array('is_home','is_single','is_page','is_category'); 
				...
				<option value="<?php echo $cat; ?>"><?php echo 'display if ' . preg_replace('#_#', ' ', $cat); ?></option>
                <?php } ?>
			  </select>
      ...
      <tr valign="top">
		...
		<td class="kma-admin-td">#<input type="text" style="width:125px;" maxlength="255" name="kma_background_color" id="kma_background_color" class="regular-text" />
	...
	foreach($types as $key => $type)
			{
				...
				/*var_dump($kma);*/
				if($kma) {
					$display_type = preg_replace('#_#', ' ', $type);
				?>
             ...
             <br />&nbsp;<br />
        <table class="widefat options" style="width: 650px">
	   <th colspan="2" class="dashboard-widget-title"><?php echo '<span style="text-transform:uppercase;">'.$display_type.'</span>'; ?><div class="kma-holder-<?php echo $type; ?>" style="float:right"></div></th>
	  <tr valign="top">
		<td scope="row"><label>
    ...
    <tbody id="kma-container-<?php echo $type; ?>">
	  ...
	  <tr valign="top">
		...
		<input type="text" style="width:50px;" maxlength="255" disabled="disabled" value="<?php echo ''.$v->BackgroundId.''; ?>" />
		</label></td>
		<td scope="row"><label><?php echo 'img src&nbsp;' ?>
        <input type="text" style="width:125px;" maxlength="255" disabled="disabled" name="<?php echo $v->BackgroundUrl; ?>" value="<?php echo $v->BackgroundUrl; ?>" id="<?php echo ''.$v->BackgroundId.'' ?>" />
        </label></td>
         <td scope="row"><label><?php echo 'url&nbsp;' ?>
        <input type="text" style="width:125px;" maxlength="255" disabled="disabled" name="<?php echo $v->PartnerUrl; ?>" value="<?php echo $v->PartnerUrl; ?>" id="<?php echo ''.$v->PartnerUrl.'' ?>" />
        </label></td>
         <td scope="row"><label><?php echo 'Prior&nbsp;' ?>
		<input type="text" style="width:50px;" maxlength="255" disabled="disabled" value="<?php echo ''.$v->Priority.''; ?>" />
		</label></td>
        <td scope="row"><label><?php echo 'Color&nbsp;' ?>
		<input type="text" style="width:50px;" maxlength="255" disabled="disabled" value="<?php echo ''.$v->BackgroundColor.''; ?>" />
		</label></td>
	  </tr>
	  <?php } ?>
	</table>
